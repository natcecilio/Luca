  ...
  return (
    <div className={`about-container ${theme}`} >
      ...
      <p>
        ...
        My name is Luca, I have over 20 years of experience in the 3D industry that have allowed me to successfully work for local and international Creative Agencies
